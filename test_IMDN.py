...
parser.add_argument("--test_lr_folder", type=str, default='Test_Datasets/test_data/',
                    help='the folder of the input images')
parser.add_argument("--output_folder", type=str, default='results/Set5/x3')
parser.add_argument("--checkpoint", type=str, default='checkpoint_x3/epoch_25.pth',
